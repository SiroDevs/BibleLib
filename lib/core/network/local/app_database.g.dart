...
class _$BibleDao extends BibleDao {
  ...
  Future<void> markAsDownloaded(String id) async {
    await _queryAdapter
        .queryNoReturn('UPDATE bibles SET isDownloaded = 1 WHERE id = ?1',
            arguments: [id]);
  }

  @override
  Future<void> markAsSelected(String id) async {
    await _queryAdapter
        .queryNoReturn('UPDATE bibles SET isSelected = 1 WHERE id = ?1',
            arguments: [id]);
  }

  @override
  Future<void> markAsUnselected(String id) async {
    await _queryAdapter
        .queryNoReturn('UPDATE bibles SET isSelected = 0 WHERE id = ?1',
            arguments: [id]);
  }
  ...
  Future<void> deleteBible(String id) async {
    await _queryAdapter
        .queryNoReturn('DELETE FROM bibles WHERE id = ?1', arguments: [id]);
  }
}
...
class _$VerseDao extends VerseDao {
  ...
  @override
  Future<int?> countVersesInChapter(
    String bibleId,
    String chapterId,
  ) async {
