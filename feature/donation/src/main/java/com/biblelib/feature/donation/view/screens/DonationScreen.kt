package com.biblelib.feature.donation.view.screens
...
import com.biblelib.feature.donation.view.components.CryptoDonationSection
import com.biblelib.feature.donation.view.components.DiyDonationSection
import com.biblelib.feature.donation.view.components.DonationHeaderCard
import com.biblelib.feature.donation.view.components.DonationMethodFilterStrip
import com.biblelib.feature.donation.view.components.PaystackDonationSection
                            ...
                            onItemCopied = { item ->
                                ...
                                scope.launch {
                                    snackbarHostState.showSnackbar(
                                        "$item copied — thank you for supporting BibleLib!"
                                    )
                                }
                            },
                        )
                    ...
                    DonationMethod.PAYSTACK -> {
                        ...
                        CryptoDonationSection(
                            onAddressCopied = { network ->
                                ...
                                scope.launch {
                                    snackbarHostState.showSnackbar(
                                        "$network address copied — thank you for supporting BibleLib!"
                                    )
                                }
                            },
                        )
